...
class WoSSolver : public Solver<ScalarType, DIM>
{
  public:
...
extern template class WoSSolver<Scalar<1>, 2>;
extern template class WoSSolver<Scalar<1>, 3>;
extern template class WoSSolver<Scalar<3>, 2>;
extern template class WoSSolver<Scalar<3>, 3>;
