...
class WoPCachingSolver : public CachingSolver<ScalarType, DIM>
{
  public:
  ...
  private:
    ...
    std::vector<int> boundaryPointToProbeIdx_; // maps each boundary point to its probe index
...
extern template class WoPCachingSolver<Scalar<1>, 2>;
extern template class WoPCachingSolver<Scalar<1>, 3>;
extern template class WoPCachingSolver<Scalar<3>, 2>;
extern template class WoPCachingSolver<Scalar<3>, 3>;
